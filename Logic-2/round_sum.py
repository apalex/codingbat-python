...
#round down to the previous multiple of 10 if its rightmost digit is less than
#5, so 12 rounds down to 10. Given 3 ints, a b c, return the sum of their rounded
#values. To avoid code repetition, write a separate helper "def round10(num):" and
